...
const Re = "copilot-", ts = "24.4.16", Dl = "attention-required", Cl = "https://plugins.jetbrains.com/plugin/23758-vaadin", Tl = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Vl = (e, t, r) => t >= e.left && t <= e.right && r >= e.top && r <= e.bottom, rs = (e) => {
  const t = [];
  let r = is(e);
  for (; r; )
...
function Vs() {
  ve.push(import("./copilot-log-plugin-kpP2NO0T.js")), ve.push(import("./copilot-info-plugin-6ylWGipf.js")), ve.push(import("./copilot-features-plugin-0tIIrmGU.js")), ve.push(import("./copilot-feedback-plugin-V9862i2j.js")), ve.push(import("./copilot-shortcuts-plugin-D0ux8jBn.js"));
}
function js() {
  {
...
const Ls = Wi(Or);
function Xi() {
  return import("./copilot-notification-D9yHv2Ej.js");
}
const Ms = (e) => {
...
let xn = class extends Ts {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-B0abogW5.js"), await import("./copilot-init-step2-DivLyXFz.js"), Vs(), this.tabIndex = 0, Ot.hostConnectedCallback(), window.addEventListener("keydown", wn), x.onSend(this.handleSendEvent), this.removers.push(x.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(

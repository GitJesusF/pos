...
public class CustomerList extends VerticalLayout {
  ...
  public CustomerList() {
    ...
    Grid<Customer> grid = doCreateGrid();
  ...
  private Grid<Customer> doCreateGrid() {
  ...
  private void refresh(int iPage) {
    ...
    if (sSearchTerm.isEmpty()) {
      page = customerService.getAllCustomers(pageRequest);
...
//      System.out.println("> page totalElements: "+page.getTotalElements());
      ...
      page = customerService.findByFilter(sSearchTerm, pageRequest);
    }
